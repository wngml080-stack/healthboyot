...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    >
      {children}
      <DialogPrimitive.Close className="dialog-close-btn absolute z-10 flex items-center justify-center w-10 h-10 rounded-full bg-gray-100 sm:bg-transparent opacity-100 sm:opacity-70 ring-offset-background transition-opacity hover:opacity-100 active:opacity-100 active:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 disabled:pointer-events-none data-[state=open]:bg-accent data-[state=open]:text-muted-foreground">
        <X className="h-5 w-5" />
